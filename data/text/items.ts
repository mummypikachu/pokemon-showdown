export const ItemsText: { [k: string]: ItemText; } = {
	...
	lightball: {
		name: "Light Ball",
		desc: "If held by a Pikachu, its Attack and Sp. Atk are multiplied 2x.",
		gen4: {
			desc: "If held by a Pikachu, its attacks are multiplied 2x.",
		},
		gen3: {
	...
	celebinite: {
		name: "celebinite",
		desc: "If held by a Celebi, this item allows it to Mega Evolve in battle.",
	},
	clawitzernite: {
		name: "clawitzernite",
	...
	armaldite: {
		name: "Armaldite",
		desc: "If held by a Armaldo, this item allows it to Mega Evolve in battle.",
	},
	cradilite: {
		name: "Cradilite",
	...
	movilite: {
		name: "Movilite",
		desc: "If held by a Movile, this item allows it to Mega Evolve in battle.",
	},
	lucarionitez: {
		name: "Lucarionite Z",
		desc: "If held by a Lucario, this item allows it to Mega Evolve in battle.",
	...
	musculenite: {
		name: "Musculenite",
		desc: "If held by a Muscules, this item allows it to Mega Evolve in battle.",
	},
	talonflamite: {
		name: "Talonflamite",
