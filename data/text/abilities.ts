export const AbilitiesText: { [k: string]: AbilityText; } = {
	...
	healer: {
		name: "Healer",
		desc: "50% chance this Pokemon or its ally has its non-volatile status condition cured at the end of each turn.",
		shortDesc: "50% chance for this Pokémon or its ally to have status cured at the end of each turn.",
		gen6: {
	...
	ledianisunbreakable: {
		...
		shortDesc: "Ignores boosts to target's Special Defense and Defense.",
	},
	leafguard: {
		name: "Leaf Guard",
	...
	liquidvoice: {
		...
		shortDesc: "This Pokemon's sound-based moves become Water type. (1.2x Boost)",
	},
	longreach: {
		name: "Long Reach",
	...
	powerofalchemy: {
		...
		desc: "This Pokemon copies the Ability of an ally that was in battle before it. Abilities that cannot be copied are As One, Battle Bond, Comatose, Commander, Disguise, Flower Gift, Forecast, Gulp Missile, Hadron Engine, Hunger Switch, Ice Face, Illusion, Imposter, Multitype, Neutralizing Gas, Orichalcum Pulse, Power Construct, Power of Alchemy, Protosynthesis, Quark Drive, Receiver, RKS System, Schooling, Shields Down, Stance Change, Trace, Wonder Guard, Zen Mode, and Zero to Hero.",
		shortDesc: "This Pokemon copies the Ability of an ally that in before it.",
		gen8: {
	...
	toxicboost: {
		name: "Toxic Boost",
		desc: "While this Pokemon is poisoned, the power of its physical attacks is multiplied by 1.5, and can't be damaged by Poison(status) or Toxic.",
		shortDesc: "While this Pokemon is poisoned, its phys. attacks have 1.5x power. Takes no poison damage.",
	},
	toxicchain: {
		name: "Toxic Chain",
	...
	nightmareeater: {
		...
		desc: "If the opposing Pokémon is asleep, this Pokémon steals 1/8 of the opposing Pokemon's maximum HP, rounded down, at the end of each turn.",
		shortDesc: "If opposing asleep: 1/8 leeched off opponent max HP per turn.",
	},
	infernalblaze: {
		name: "Infernal Blaze",
