export const MovesText: {[k: string]: MoveText} = {
	...
	bulletseed: {
		name: "Bullet Seed",
		desc: "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times. If the user is Cacturne-Mega, this move will hit once and have 95 base power.",
		shortDesc: "Hits 2-5 times in one turn.",
		gen4: {
			desc: "Hits two to five times. Has a 3/8 chance to hit two or three times, and a 1/8 chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times. If the target has a Focus Sash and had full HP when this move started, it will not be knocked out regardless of the number of hits.",
		},
	...
	itchypollen: {
		...
		fail: "#healblock",
		removeItem: "  [SOURCE] made [POKEMON]'s [ITEM] itchy!",
	},
	cosmicpower: {
		name: "Cosmic Power",
	...
	defog: {
		...
		shortDesc: "-1 evasion; clears terrain and hazards on both sides. & Clears trickroom.",
		gen7: {
	...
	dreammist: {
		...
		shortDesc: "20% chance to make the target fall asleep.",
	},
	dorminrush: {
		name: "Dormin Rush",
	...
	dreamcrusher: {
		name: "Dream Crusher",
		desc: "This move deals double damage to sleeping targets, but cures their sleep.",
		shortDesc: "Double damage to sleeping targets+cures sleep.",
	},
	...
	charredterrain: {
		...
		desc: "For 5 turns, the terrain becomes Charred Terrain. During the effect, the power of Fire-type attacks made by grounded Pokemon is multiplied by 1.3.",
		shortDesc: "5 turns. Grounded: +Fire power.",
		gen7: {
			desc: "For 5 turns, the terrain becomes Charred Terrain. During the effect, the power of Electric-type attacks made by grounded Pokemon is multiplied by 1.5 and grounded Pokemon cannot fall asleep; Pokemon already asleep do not wake up. Grounded Pokemon cannot become affected by Yawn or fall asleep from its effect. Camouflage transforms the user into an Electric type, Nature Power becomes Thunderbolt, and Secret Power has a 30% chance to cause paralysis. Fails if the current terrain is Electric Terrain.",
		},
	},
	electrify: {
		name: "Electrify",
	...
	flowerdance: {
		name: "Flower Dance",
		desc: "Raises Sp. Attack by 2 stages.",
		shortDesc: "Raises Sp. Attack by 2 stages.",
	},
	fly: {
		name: "Fly",
	...
	glacierstream: {
		...
		start: "  Frigid spears form around [TEAM]!",
		end: "  The spears are knocked away from around [TEAM]!",
		damage: "  The spears stab into [POKEMON]!",
	},
	glaciallance: {
		name: "Glacial Lance",
		desc: "No additional effect.",
	...
	rockyblockade: {
		name: "Rocky Blockade",
		shortDesc: "Protects allies from all moves this turn.",
	},
	roleplay: {
		name: "Role Play",
	...
	poisonmist: {
		name: "Poison Mist",
		desc: "Has a 60% chance to either poison or badly poison the target.",
		shortDesc: "60% chance to poison or badly poison target.",
	},
	trick: {
		name: "Trick",
		desc: "The user swaps its held item with the target's held item. Fails if either the user or the target is holding a Mail or Z-Crystal, if neither is holding an item, if the user is trying to give or take a Mega Stone to or from the species that can Mega Evolve with it, or if the user is trying to give or take a Blue Orb, a Red Orb, a Griseous Orb, a Plate, a Drive, or a Memory to or from a Kyogre, a Groudon, a Giratina, an Arceus, a Genesect, or a Silvally, respectively. The target is immune to this move if it has the Sticky Hold Ability.",
	...
	weatherball: {
		...
		gen8: {
			desc: "Power doubles if a weather condition other than Delta Stream is active, and this move's type changes to match. Ice type during Hail, Water type during Primordial Sea or Rain Dance, Rock type during Sandstorm, and Fire type during Desolate Land or Sunny Day, Flying during Windy or Delta Stream. If the user is holding Utility Umbrella and uses Weather Ball during Primordial Sea, Rain Dance, Desolate Land, or Sunny Day, this move remains Normal type and does not double in power.",
		},
		gen5: {
