...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standardnopreview: {
		effectType: 'ValidatorRule',
		name: 'Standard No Preview',
		desc: "The standard ruleset for all offical Smogon singles tiers (Ubers, OU, etc.)",
		ruleset: [
			'Sleep Clause Mod', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Items Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
			'Obtainable',
		],
	...
	standarddoubles: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
			'Min Source Gen = 9',
		],
	},
	standardoms: {
	...
	formmegaclause: {
		...
		onValidateSet(set) {
			...
			if (set.species === 'Pyroar-Wildfire' && set.item === 'Pyroarite') {
				return ["Pyroar-Wildfire cannot hold Pyroarite."];
			}
		},
	},
};
