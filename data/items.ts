export const Items: import('../sim/dex-items').ItemDataTable = {
	...
	articunite: {
		name: "Articunite",
		spritenum: 575,
		megaStone: { "Articuno": "Articuno-Mega" },
        itemUser: ["Articuno"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	luminite: {
		name: "Luminite",
		spritenum: 575,
		megaStone: { "Lumineon": "Lumineon-Mega" },
        itemUser: ["Lumineon"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	archeopsite: {
		name: "Archeopsite",
		spritenum: 575,
		megaStone: { "Archeops": "Archeops-Mega" },
        itemUser: ["Archeops"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	meowsticite: {
		name: "Meowsticite",
		spritenum: 627,
		megaStone: { "Meowstic": "Meowstic-Mega" },
	...
	regigigite: {
		name: "Regigigite",
		spritenum: 627,
		megaStone: { "Regigigas": "Regigigas-Mega" },
        itemUser: ["Regigigas"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cradilite: {
		name: "Cradilite",
		spritenum: 627,
		megaStone: { "Cradily": "Cradily-Mega" },
        itemUser: ["Cradily"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	grafainite: {
		name: "Grafainite",
		spritenum: 627,
		megaStone: { "Grafaiai": "Grafaiai-Mega" },
        itemUser: ["Grafaiai"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	musculenite: {
		name: "Musculenite",
		spritenum: 627,
		megaStone: { "Muscules": "Muscules-Mega" },
        itemUser: ["Muscules"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	wormadite: {
		name: "Wormadite",
		spritenum: 627,
		megaStone: { "Wormadam": "Wormadam-Mega" },
	...
	pichunite: {
		name: "Pichunite",
		spritenum: 580,
		megaStone: { "Pichu-Spiky-eared": "Pichu-Mega" },
	...
	toroikite: {
		name: "Toroikite",
		spritenum: 625,
		megaStone: { "Toroika": "Toroika-Mega" },
        itemUser: ["Toroika"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	heartlocker: {
		...
		onBeforeMove(pokemon, target, move) {
			if (this.randomChance(15, 100)) {
				this.add('-activate', pokemon, 'item: Heart Locker');

				const damage = this.actions.getConfusionDamage(pokemon, 40);
				if (damage) this.damage(damage, pokemon, pokemon);
