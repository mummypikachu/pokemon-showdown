...
const Setup = [
	...
	'shellsmash', 'shiftgear', 'swordsdance', 'tailglow', 'tidyup', 'trailblaze', 'workup', 'shellsmash',
];
...
export class RandomTeams {
	...
	getAbility(
		...
		if (species.id === 'movilemega') return 'Static';
		if (species.id === 'pyroarmega') return 'Unnerve';
		if (species.id === 'delphoxmega') return 'Blaze';
		if (species.id === 'froslassmega') return 'Cursed Body';
		if (species.id === 'scovillainmega') return 'Chlorophyll';
		if (species.id === 'floettemega') return 'Flower Veil';
		if (species.id === 'excadrillmega') return 'Sand Rush';
		if (species.id === 'tyrantrummega') return 'Strong Jaw';
		if (species.id === 'mismagiusmega') return 'Levitate';
		if (species.id === 'dragalgemega') return 'Adaptability';
		if (species.id === 'mukmega') return 'Poison Touch';
		if (species.id === 'donphanmega') return 'Sturdy';
		if (species.id === 'cacturnemega') return 'Water Absorb';
		if (species.id === 'feraligatrmega') return 'Sheer Force';
		if (species.id === 'meganiummega') return 'Overgrow';
		if (species.id === 'emboarmega') return 'Reckless';
		if (species.id === 'raichumegax') return 'Lightning Rod';
		if (species.id === 'raichumegay') return 'Lightning Rod';
		if (species.id === 'victreebelmega') return 'Venomous';
		if (species.id === 'hawluchamega') return 'Mold Breaker';
		if (species.id === 'malamarmega') return 'Contrary';
