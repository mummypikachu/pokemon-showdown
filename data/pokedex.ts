export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	poochyena: {
		...
		abilities: {0: "Run Away", 1: "Moxie", H: "Rattled"},
		heightm: 0.5,
		weightkg: 13.6,
		color: "Gray",
		evos: ["Mightyena"],
	...
	mightyena: {
		...
		name: "Mightyena",
		types: ["Dark"],
		baseStats: {hp: 80, atk: 105, def: 90, spa: 60, spd: 85, spe: 100},
		abilities: {0: "Intimidate", 1: "Moxie", H: "Opportunist"},
		heightm: 1,
		weightkg: 37,
		color: "Gray",
		prevo: "Poochyena",
	...
	ponku: { // water pump pokemon. name placeholder
		...
		types: ["Water", "Fighting"],
		baseStats: {hp: 60, atk: 40, def: 60, spa: 40, spd: 60, spe: 35},
		abilities: {0: "Water Absorb", 1: "Chlorophyll", H: "Iron Fist"},
		heightm: 0.3,
		weightkg: 5,
		color: "Yellow",
		eggGroups: ["Field"],
